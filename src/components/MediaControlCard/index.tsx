...
export default function MediaControlCard() {
  ...
  return (
    <Card
      sx={{ borderRadius: 0, display: 'flex', boxShadow: '0 0 8px rgba(0, 0, 0, 0.1)', height: '100px', width: '100%' }}
    >
      <Box sx={{ flex: '1 1 30%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <CardContent sx={{ flex: '1', pl: '30px', flexBasis: '33.33%' }}>
      ...
      <Box sx={{ flex: '1 1 30%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <Image
          style={{ minWidth: 151, flexShrink: 0, alignSelf: 'stretch', flexBasis: '33.33%' }}
