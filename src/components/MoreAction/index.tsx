...
import { ControlPoint, Download } from '@mui/icons-material';
...
import { PlaylistItem, SongTitle, StyledBox, StyledBoxTitle } from './styles';
import { IMoreActionProps } from './types';

export const MoreAction: React.FC<IMoreActionProps> = ({ song }) => {
  const { isOpenMoreAction, setIsOpenMoreAction } = useContext(KContext);
  const handleClose = () => setIsOpenMoreAction(false);
